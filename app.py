...
server = os.getenv('DB_SERVER', 'cloudcherrytree-sqlserver.database.windows.net')
database = os.getenv('DB_DATABASE', 'cloudcherrytreesql')
username = os.getenv('DB_USERNAME', 'cloudcherrytree-admin')
password = os.getenv('DB_PASSWORD', 'Secreto-Acero-11-!')
